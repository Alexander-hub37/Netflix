...
@section('content')
    ...
    <br><br>
    <a href="{{ route('genders.create') }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mb-6">
        Create New Genders
    </a>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr class="bg-white border-b white:bg-gray-800 gray:border-gray-700 hover:bg-gray-50 gray:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4">
                    <!--<a href="{{ route('genders.show', $gender) }}" class="font-medium text-red-600 dark:text-red-500 hover:underline">View</a>-->
                        <div class="flex">
                            <a href="{{ route('genders.edit', $gender) }}" class="font-medium text-red-600 dark:text-red-500 hover:underline">
