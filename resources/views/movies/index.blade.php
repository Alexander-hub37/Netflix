...
<div class="container mx-auto px-4">
    <br><br>
    <a href="{{ route('movies.create') }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mb-6">
        Create New Movies
    </a>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 white:bg-gray-700 :text-gray-600">
                <tr>
            ...
            <tbody>
                <tr class="bg-white border-b white:bg-gray-800 gray:border-gray-700 hover:bg-gray-50 gray:hover:bg-gray-600">
                    <td class="p-4">
                        <img src="{{ asset($movie->image) }}" alt="Image" class="w-16 md:w-32 max-w-full max-h-full">
                    </td>
                    <td class="px-6 py-4 font-semibold text-gray-900 dark:text-dark">
                    {{ $movie->title }}
                    </td>
                    <td class="px-6 py-4 font-semibold text-gray-900 dark:text-dark">
                    {{ $movie->description }}
                    ...
                    <td class="px-6 py-4">
                    <a href="{{ route('movies.show', $movie) }}" class="font-medium text-red-600 dark:text-red-500 hover:underline">View</a>
                        <div class="flex">
                            <a href="{{ route('movies.edit', $movie) }}" class="font-medium text-red-600 dark:text-red-500 hover:underline">
